        ...
        <div class="col-md-8">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    ...
                    <div>
                        <button onclick="displayStories('${story.title}')" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#NewsModal">Read More...</button>
                    </div>
            </div>
        </div>
    </div>        `
...
const displayCategories = categories => {
    ...
    categories.forEach(category => {
        ...
        <ul class="navbar-nav">
                        <li class="nav-item">
                            <a onclick="loadCategoryWiseStoryDetails(${category.category_id})" class="nav-link active" aria-current="page" href="#">${category.category_name}</a>
                        </li>
                    </ul>
        `
...
const displayCategoryWiseStoryDetails = storyCategory => {
